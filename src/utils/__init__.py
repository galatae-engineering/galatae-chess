...
def draw_bounding_box_on_image(image,
  ...
  # instead of above.
  #display_str_heights = [font.getsize(ds)[1] for ds in display_str_list]  #Previous version, change to getbbox()
  ...
  for display_str in display_str_list[::-1]:
    #text_width, text_height = font.getsize(display_str)  #Previous version, change to getbbox()
