...
class ChessboardCalibration(Debugable):
  ...
  def mapping(self, chessboard_img=None, fix_rotate=False, rotate_val=0, add_padding=False, apply_kdilate=True, smooth_ksize=(11, 11)):
    """
  ...
  def cropImage(self, chessboard_image, biggest_cnt):
    ...
    """
    cv2.imwrite('debug/WHEEERE.jpg', chessboard_image)
    transformed = perspective_transform(chessboard_image.copy(), biggest_cnt)
    cv2.imwrite('debug/WHERE.jpg', transformed)
